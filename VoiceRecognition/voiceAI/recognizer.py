...
from voiceAI.logger import *
from voiceAI.audiodata import *

class Recognizer(AudioSource):
    def __init__(self):
        self.energy_threshold = 250  # minimum audio energy to consider for recording
    ...
    def recognize_google(self, audio_data, key=None, language="en-US", show_all=False):
        ...
        for line in actual_result["alternative"]:
            line["confidence"] = actual_result["alternative"][0]["confidence"]
